...
{-|
Module      : Paths_semantic_categorical_oracle
...
-- at runtime using the environment variable semantic_categorical_oracle_bindir.
...
-- environment variable semantic_categorical_oracle_libdir.
...
-- using the environment variable semantic_categorical_oracle_dynlibdir.
...
-- runtime using the environment variable semantic_categorical_oracle_datadir.
...
-- variable semantic_categorical_oracle_libexedir.
...
-- using the environment variable semantic_categorical_oracle_sysconfdir.
...
libdir     = "/root/.cabal/lib/x86_64-linux-ghc-9.12.4-5301/semantic-categorical-oracle-0.1.0.0-inplace-semantic-categorical-oracle"
dynlibdir  = "/root/.cabal/lib/x86_64-linux-ghc-9.12.4-5301"
datadir    = "/root/.cabal/share/x86_64-linux-ghc-9.12.4-5301/semantic-categorical-oracle-0.1.0.0"
libexecdir = "/root/.cabal/libexec/x86_64-linux-ghc-9.12.4-5301/semantic-categorical-oracle-0.1.0.0"
sysconfdir = "/root/.cabal/etc"

getBinDir     = catchIO (getEnv "semantic_categorical_oracle_bindir")     (\_ -> return bindir)
getLibDir     = catchIO (getEnv "semantic_categorical_oracle_libdir")     (\_ -> return libdir)
getDynLibDir  = catchIO (getEnv "semantic_categorical_oracle_dynlibdir")  (\_ -> return dynlibdir)
getDataDir    = catchIO (getEnv "semantic_categorical_oracle_datadir")    (\_ -> return datadir)
getLibexecDir = catchIO (getEnv "semantic_categorical_oracle_libexecdir") (\_ -> return libexecdir)
getSysconfDir = catchIO (getEnv "semantic_categorical_oracle_sysconfdir") (\_ -> return sysconfdir)
